...
- **Market-Closed Cache**: The dashboard automatically detects when the US stock market is closed. It then caches all price data locally in the browser for 30 minutes. This completely prevents rate-limit bans (Twelve Data limits to 8 req/min) on weekends or nights, meaning you can leave auto-refresh turned on indefinitely during off-hours.
